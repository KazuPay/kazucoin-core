...
#ifndef KAZUCOIN_QT_SPLASHSCREEN_H
#define KAZUCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Kazucoin Core initialization
...
#endif // KAZUCOIN_QT_SPLASHSCREEN_H
