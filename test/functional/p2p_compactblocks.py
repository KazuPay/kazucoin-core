...
# TestP2PConn: A peer we use to send messages to kazucoind, and store responses.
...
class CompactBlocksTest(KazucoinTestFramework):
    ...
    # This test actually causes kazucoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that kazucoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for kazucoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # kazucoind will not send blocktxn responses for blocks whose height is
