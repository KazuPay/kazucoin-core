...
* kazucoin.conf: contains configuration settings for kazucoind or kazucoin-qt
* kazucoind.pid: stores the process id of kazucoind while running
...
* debug.log: contains debug information and general logging generated by kazucoind or kazucoin-qt
