...
#ifndef KAZUCOIN_KEYSTORE_H
#define KAZUCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/kazucoin/bips/blob/master/bip-0013.mediawiki
