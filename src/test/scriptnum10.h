...
#ifndef KAZUCOIN_TEST_SCRIPTNUM10_H
#define KAZUCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Kazucoin Core 0.10.0, for cross-comparison.
 */
public:
