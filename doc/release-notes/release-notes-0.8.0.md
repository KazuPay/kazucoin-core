Kazucoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/kazucoin/files/Kazucoin/kazucoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Kazucoin
...
New/changed settings (command-line or kazucoin.conf file)
--------------------------------------------------------
