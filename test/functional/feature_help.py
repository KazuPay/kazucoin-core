...
"""Verify that starting kazucoin with -h works as expected."""
import subprocess

from test_framework.test_framework import KazucoinTestFramework
from test_framework.util import assert_equal

class HelpTest(KazucoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kazucoin with -h for help text")
        ...
        self.log.info("Start kazucoin with -version for version information")
        ...
        self.log.info("Start kazucoind with -fakearg to make sure it does not start")
