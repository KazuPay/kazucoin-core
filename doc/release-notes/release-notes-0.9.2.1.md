Kazucoin Core version 0.9.2.1 is now available from:

  https://kazucoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 KAZU to 0.01 KAZU
...
- Fix "Start kazucoin on system login"
