...
These are the dependencies currently used by Kazucoin Core. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| libjpeg |  |  |  |  | [Yes](https://github.com/kazucoin/kazucoin/blob/master/depends/packages/qt.mk#L75) |
| libpng |  |  |  |  | [Yes](https://github.com/kazucoin/kazucoin/blob/master/depends/packages/qt.mk#L74) |
| MiniUPnPc | [2.0.20170509](http://miniupnp.free.fr/files) |  | No |  |  |
| OpenSSL | [1.0.1k](https://www.openssl.org/source) |  | Yes |  |  |
| PCRE |  |  |  |  | [Yes](https://github.com/kazucoin/kazucoin/blob/master/depends/packages/qt.mk#L76) |
