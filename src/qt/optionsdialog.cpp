    ...
    mapper(0)
{
    ...
    ui->theme->addItem(QString("KAZU-Black"), QVariant("black"));
    ui->theme->addItem(QString("KAZU-Blue"), QVariant("blue"));
    ui->theme->addItem(QString("KAZU-White"), QVariant("white"));
 


    QDir translations(":translations");

    ui->kazucoinAtStartup->setToolTip(ui->kazucoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->kazucoinAtStartup->setText(ui->kazucoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openKazucoinConfButton->setToolTip(ui->openKazucoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new KazucoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->kazucoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openKazucoinConfButton_clicked()
{
