...
# Copyright 2016 The Kazucoin Core developers
...
help_text="""Test framework for kazucoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/kazucoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "kazucoin-util-test.json", buildenv)
