...
This document provides guidelines for internationalization of the Kazucoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kazucoin_en.ts` remains unchanged.
