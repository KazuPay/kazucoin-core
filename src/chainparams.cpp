...
public:
    CMainParams() {
        ...
        **/
        ...
        consensus.nMinActualTimespanV4fix = consensus.nAveragingTargetTimespanV4fix * (100 - consensus.nMaxAdjustUpV4) / 100;
        consensus.nMaxActualTimespanV4fix = consensus.nAveragingTargetTimespanV4fix * (100 + consensus.nMaxAdjustDownV4) / 100;
        ...
        consensus.nRuleChangeActivationThreshold = 3024; // 28224 - 70% of 40320
        consensus.nMinerConfirmationWindow = 4032; // nPowTargetTimespan / nPowTargetSpacing 40320 main net - 1 week
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 0; // March 24th, 2017 1490355345
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 999999999999ULL; // March 24th, 2018

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 13; //Add VERSIONBITS_NUM_BITS_TO_SKIP (12)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 0; // March 24th, 2017 1490355345
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 999999999999ULL; // March 24th, 2018
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_NVERSIONBIPS].nStartTime = 0; // March 24th, 2017 1490355345
        consensus.vDeployments[Consensus::DEPLOYMENT_NVERSIONBIPS].nTimeout = 999999999999ULL;    // March 24th, 2018
        ...
        checkpointData = (CCheckpointData) {
         {
            ...
            { 117000, uint256S("0x2399daf22822979a2f081d18825d36478d5283b7f518c2f2bba0bdad7701cd1f")},
