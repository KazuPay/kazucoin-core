...
// Copyright (c) 2009-2013 The Kazucoin developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef KAZUCOIN_BIGNUM_H
#define KAZUCOIN_BIGNUM_H
...
public:
    ...
    //
    // Kazucoin only uses this "compact" format for encoding difficulty
