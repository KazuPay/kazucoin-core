...
class TxnMallTest(KazucoinTestFramework):
    ...
    def run_test(self):
        ...
        # All nodes should start with 1,250 KAZU:
        ...
        # Node0's balance should be starting balance, plus 50KAZU for another
        ...
        # Check node0's total balance; should be same as before the clone, + 100 KAZU for 2 matured,
