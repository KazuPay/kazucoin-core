...
unlocked to sign the Kazucoin-Qt.app bundle.
...
allowing somebody to distribute a Kazucoin-Qt.app or kazucoin-qt-setup.exe with a valid
...
that the kazucoin-qt.exe file inside the installer had not been tampered with.
