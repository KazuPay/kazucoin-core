...
./bootstrap.sh --prefix=/{your kazucoin github clone path}/kazucoin-core/boostkazucoin 
./b2 install --prefix=/{your kazucoin github clone path}/kazucoin-core/boostkazucoin --layout=tagged --threading=multi --without-mpi --build-type=complete
cd ~
