 ...
 */
#ifndef KAZUCOIN_UTIL_H
#define KAZUCOIN_UTIL_H
...
extern const char * const KAZUCOIN_CONF_FILENAME;
extern const char * const KAZUCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("kazucoin-%s", name);
