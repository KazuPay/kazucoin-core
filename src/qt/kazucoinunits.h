...
#ifndef KAZUCOIN_QT_KAZUCOINUNITS_H
#define KAZUCOIN_QT_KAZUCOINUNITS_H
...
/** Kazucoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KazucoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KazucoinUnits(QObject *parent);

    /** Kazucoin units.
      @note Source: https://en.kazucoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KAZU,
...
typedef KazucoinUnits::Unit KazucoinUnit;

#endif // KAZUCOIN_QT_KAZUCOINUNITS_H
