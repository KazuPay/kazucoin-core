...
#ifndef KAZUCOIN_WALLET_WALLET_H
#define KAZUCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this kazucoin node, and set to 0 for transactions that were created
...
#endif // KAZUCOIN_WALLET_WALLET_H
