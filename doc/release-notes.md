Kazucoin Core version 0.16.0 is now available from:

  <https://kazucoincore.org/bin/kazucoin-core-0.16.0/>
...
installer (on Windows) or just copy over `/Applications/Kazucoin-Qt` (on Mac)
or `kazucoind`/`kazucoin-qt` (on Linux).
...
Kazucoin Core now has more flexibility in where the wallets directory can be
located. Previously wallet database files were stored at the top level of the
kazucoin data directory. The behavior is now:
...
------------------------------------
The minimum version of the GCC compiler required to compile Kazucoin Core is now 4.8. No effort will be
...
GUI changes
-----------
- Uses of "µKAZU" in the GUI now also show the more colloquial term "bits", specified in BIP176.
