Kazucoin Core version 0.13.2 is now available from:

  <https://kazucoin.org/bin/kazucoin-core-0.13.2/>
...
- #8908 `4a974b2` Update kazucoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow kazucoin-tx to create v2 transactions (dgbdrak)
