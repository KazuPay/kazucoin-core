Kazucoin Core version 0.10.4 is now available from:

  <https://kazucoin.org/bin/kazucoin-core-0.10.4/>
...
- #6953 `43c2789` Split kazucoin-tx into its own package
- #6953 `dfe0d4d` Include kazucoin-tx binary on Debian/Ubuntu
