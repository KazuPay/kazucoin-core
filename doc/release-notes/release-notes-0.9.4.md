Kazucoin Core version 0.9.4 is now available from:

  https://kazucoin.org/bin/0.9.4/
...
this update is incompatible with the Kazucoin system and could lead to consensus
forks.

Kazucoin Core released binaries from https://kazucoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~kazucoin/+archive/ubuntu/kazucoin
- A third-party or self-compiled Kazucoin Core

upgrade to Kazucoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
