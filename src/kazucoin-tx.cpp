...
static void SetupKazucoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = strprintf("%s kazucoin-tx utility version", PACKAGE_NAME) + " " + FormatFullVersion() + "\n\n" +
            "Usage:\n"
              "  kazucoin-tx [options] <hex-tx> [commands]  Update hex-encoded kazucoin transaction\n" +
              "  kazucoin-tx [options] -create [commands]   Create hex-encoded kazucoin transaction\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kazucoin transaction
